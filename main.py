...
root,title,update_ack,status_output = initiate()
...
def mainFrame():
    ...
    button1 = ttk.Button(frame1,text="Rentee Details",command=lambda: [renteeDetailPage(),frame1.destroy(),title.config(text="Rentee Details",font=(14)),update_ack.config(text="")],width=20)
    button1.grid(row=1,column=0,padx=30,pady=10)

    button2 = ttk.Button(frame1,text="Rental Payment",command=lambda:[rentalPaymentPage(),frame1.destroy(),title.config(text="Rental Payment",font=(14)),update_ack.config(text="")],width=20)
    button2.grid(row=1,column=1,padx=30,pady=10)

    button3 = ttk.Button(frame1,text="Electricity Use",command=lambda:[electricityUsedPage(),frame1.destroy(),title.config(text="Electricity Use",font=(14)),update_ack.config(text="")],width=20)
    button3.grid(row=2,column=0,padx=30,pady=10)

    button4 = ttk.Button(frame1,text="Electricity Payment",command=lambda: [electricityPaymentPage(),frame1.destroy(),title.config(text="Electricity Payment",font=(14)),update_ack.config(text="")],width=20)
    button4.grid(row=2,column=1,padx=30,pady=10)

    button5 = ttk.Button(frame1,text="Status Page",command=lambda:[statusPage(),frame1.destroy(),title.config(text="Stats"),update_ack.config(text="")],width=20)
    ...
    update_ack.config(text='Designed by Aman Kisan')
...
def renteeLeavingDatePage():
    ...
    back_btn = ttk.Button(frame2,text="Back",command= lambda: [renteeDetailPage(),frame2.destroy(),title.config(text="Rentee Details",font=(20)),update_ack.config(text="",fg="black")],width=20)
...
def rentalPaymentPage():
    ...
    back_btn = ttk.Button(frame3,text="Back",command= lambda: [mainFrame(),frame3.destroy(),title.config(text="Rental Management System",font=(20)),update_ack.config(text="",fg="black")],width=20)
...
def electricityUsedPage():
    ...
    back_btn = ttk.Button(frame4,text="Back",command= lambda: [mainFrame(),frame4.destroy(),title.config(text="Rental Management System",font=(20)),update_ack.config(text="",fg="black")],width=20)
...
def electricityPaymentPage():
    ...
    back_btn = ttk.Button(frame5,text="Back",command= lambda: [mainFrame(),frame5.destroy(),title.config(text="Rental Management System",font=(20)),update_ack.config(text="",fg="black")],width=20)
    back_btn.grid(row=3,column=0,padx=10,pady=15)
...
def statusPage():
    ...
    button1 = ttk.Button(frame1,text="Check Advance Booking",command=lambda:[statusInputPage(RMS.stats.func1),frame1.destroy()],width=36)
    button1.pack(pady=10)

    button2 = ttk.Button(frame1,text="Check Number of days rentee stayed",command=lambda:[statusInputPage(RMS.stats.func2),frame1.destroy()],width=36)
    button2.pack(pady=10)

    button3 = ttk.Button(frame1,text="Check No. of days house was vacant",command=lambda:[statusInputPage(RMS.stats.func3),frame1.destroy()],width=36)
    button3.pack(pady=10)    # this actually takes the rentee's name who last stayed in the 
    
    button4 = ttk.Button(frame1,text="Check No. of payments rentee made",command=lambda:[statusInputPage(RMS.stats.func4),frame1.destroy()],width=36)
    button4.pack(pady=10)

    button5 = ttk.Button(frame1,text="Check the pending electric used amount",command=lambda:[statusInputPage(RMS.stats.func5),frame1.destroy()],width=36)
    button5.pack(pady=10)

    button6 = ttk.Button(frame1,text="Check money to be returned to rentee",command=lambda:[statusInputPage(RMS.stats.func6),frame1.destroy()],width=36)
...
def statusInputPage(func):
    ...
    back_btn = ttk.Button(frame2,text="Back",command= lambda: [statusPage(),frame2.destroy(),title.config(text="Stats",font=(20)),status_output.config(text="")],width=20)
