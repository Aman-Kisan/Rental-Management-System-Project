'''This is a testing version of the ".RMS/main.py", any changes made is tested here first
then this file is copied to ".RMS/main.py" '''
...
if __name__ != '__main__':
    ...
    # THE AMOUNT TO BE PAID BY THE RENTEE IS (THE SUM OF THE UNSETTLED MONEY AND THE AMOUNT)
